...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Pertanyaan, Jawaban FROM informasi_faq';
// Set the table to where you add the data
$grid->table = 'informasi_faq';
...
$Model = array(
    ...
    array("name"=>"Pertanyaan","label"=>"Pertanyaan","width"=>25),
    array("name"=>"Jawaban","label"=>"Jawaban","width"=>50)
);
