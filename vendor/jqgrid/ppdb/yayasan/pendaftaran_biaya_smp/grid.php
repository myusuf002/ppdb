...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Jalur, BiayaPendaftaran, BiayaPendidikan, BiayaPembangunan, BiayaTotal FROM pendaftaran_biaya_smp';
// Set the table to where you add the data
$grid->table = 'pendaftaran_biaya_smp';
