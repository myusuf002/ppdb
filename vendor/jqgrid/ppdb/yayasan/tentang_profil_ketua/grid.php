...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Gambar, Nama, Profil FROM tentang_profil_ketua';
// Set the table to where you add the data
$grid->table = 'tentang_profil_ketua';
...
$Model = array(
    ...
    array("name"=>"Profil","label"=>"Profil","width"=>50)
);
