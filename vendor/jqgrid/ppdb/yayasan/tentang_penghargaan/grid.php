...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Gambar, Judul, Deskripsi FROM tentang_penghargaan';
// Set the table to where you add the data
$grid->table = 'tentang_penghargaan';
...
$Model = array(
	...
	array("name"=>"Judul","label"=>"Judul","width"=>25),
