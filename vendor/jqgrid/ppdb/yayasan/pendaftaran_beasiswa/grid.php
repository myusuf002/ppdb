...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Gambar, Judul, Tenggat, Deskripsi FROM pendaftaran_beasiswa';
// Set the table to where you add the data
$grid->table = 'pendaftaran_beasiswa';
...
$Model = array(
	...
	array("name"=>"Tenggat","label"=>"Tenggat","width"=>25),
...
$grid->setColProperty('Tenggat', 
             array("formoptions"=>array("label"=>"Tenggat"),"editable"=>true,"formatter"=>"date","datefmt"=>'d/m/Y',"formatoptions"=>array("srcformat"=>"Y-m-d H:i:s", "newformat"=>"Y-m-d"),
