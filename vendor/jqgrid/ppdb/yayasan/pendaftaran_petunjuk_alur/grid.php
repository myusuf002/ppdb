...
// Write the SQL Query
$grid->SelectCommand = 'SELECT ID, Alur, Deskripsi FROM pendaftaran_petunjuk_alur';
// Set the table to where you add the data
$grid->table = 'pendaftaran_petunjuk_alur';
...
$Model = array(
    ...
    array("name"=>"Alur","label"=>"Alur","width"=>25),
