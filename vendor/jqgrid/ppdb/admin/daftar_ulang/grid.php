...
// Write the SQL Query
$grid->SelectCommand = 'SELECT Nisn, NamaLengkap, JenisPembayaran, TotalBiaya, BatasPembayaran, Bukti, Status FROM admin_daftar_ulang';
// Set the table to where you add the data
$grid->table = 'admin_daftar_ulang';
...
$grid->setColProperty('Nisn', array("editrules"=>array("required"=>true)));
// Enable navigator
$grid->navigator = true;
