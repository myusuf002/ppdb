...
// Write the SQL Query
$grid->SelectCommand = 'SELECT KartuIdentitas, KartuKeluarga, FormulirPendaftaran, PasFoto, SkKelakuanBaik, SkSehat, Skhun, IjazahTerakhir, Status FROM admin_data_berkas';
// Set the table to where you add the data
$grid->table = 'admin_data_berkas';
$grid->setPrimaryKeyId('KartuIdentitas');
...
$grid->setColProperty('KartuIdentitas', array("editrules"=>array("required"=>false)));
// Enable navigator
$grid->navigator = true;
