...
// Write the SQL Query
$grid->SelectCommand = 'SELECT TokenPendaftaran, Username, Email, NoHp, Password FROM admin_data_akun';
// Set the table to where you add the data
$grid->table = 'admin_data_akun';
$grid->setPrimaryKeyId('TokenPendaftaran');
...
$grid->setColProperty('TokenPendaftaran', array("editrules"=>array("required"=>true)));
// Enable navigator
$grid->navigator = true;
