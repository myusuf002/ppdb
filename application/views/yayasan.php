                        ...
                        <div class="row mx-4 my-3 bg-white border-danger border rounded-lg">
                            <div class="col-md-12 p-2">
                                <div class="row">
                                    ...
                                    <a  href="<?php echo site_url("Yayasan/pendaftaran") ?>" class="btn btn-danger col-md-2 align-self-center">
                                        Daftar Sekarang
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="row mx-1 my-3 text-center">
                            <div class="card m-1" style="width:350px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url("Yayasan/sekolah/SMK"); ?>" class="btn btn-danger">Selengkapnya</a>
                                </div>
                            </div>
                            <div class="card m-1" style="width:350px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url("Yayasan/sekolah/SMA"); ?>" class="btn btn-danger">Selengkapnya</a>
                                </div>
                            </div>
                            <div class="card m-1" style="width:350px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url("Yayasan/sekolah/SMP"); ?>" class="btn btn-danger">Selengkapnya</a>
                                </div>
                            </div>
                            <div class="card m-1" style="width:350px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url("Yayasan/sekolah/SD"); ?>" class="btn btn-danger">Selengkapnya</a>
                                </div>
                            </div>
                            <div class="card m-1" style="width:350px">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="<?php echo site_url("Yayasan/sekolah/TK"); ?>" class="btn btn-danger">Selengkapnya</a>
                                </div>
                            </div>
                        </div>
