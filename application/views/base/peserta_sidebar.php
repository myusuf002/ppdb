...
<ul class="navbar-nav sidebar sidebar-light bg-light pt-5" id="accordionSidebar">
    ...
    <div id="collapseRegistration" class="collapse" aria-labelledby="headingRegistration" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="<?php echo site_url("Peserta/dataDiri"); ?>">Data Diri</a>
        <a class="collapse-item" href="<?php echo site_url("Peserta/dataSekolah"); ?>">Data Sekolah Asal</a>   
    </div>
    </li>

    <!-- Nav Item - About Collapse Menu -->
    <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url("Peserta/berkas"); ?>" >
    ...
    <li class="nav-item">
    <a class="nav-link" href="<?php echo site_url("Peserta/daftarUlang"); ?>">
    ...
    <div id="collapseInformasi" class="collapse" aria-labelledby="headingInformasi" data-parent="#accordionSidebar">
        ...
        <a class="collapse-item" href="<?php echo site_url("Peserta/aktivasiAkun"); ?>">Aktivasi Akun</a>
        <a class="collapse-item" href="<?php echo site_url("Peserta/pengaturan"); ?>">Pengaturan</a>
        <a class="collapse-item" href="<?php echo site_url("Peserta/logout"); ?>">Keluar</a>
        </div>
    </div>
    </li>
