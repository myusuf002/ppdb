...
<body>
    ...
    <nav class="navbar navbar-expand fixed-top navbar-light bg-light border-bottom topbar pr-0">
        ...
        <a class="navbar-brand ml-2" href="<?= site_url(); ?>">
            <img src="<?= base_url(); ?>assets/img/logo/logo-name-ppdb.png"  height="30" class="d-none d-sm-block">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown mr-2">
                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                   data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <span class="mr-2 d-none d-lg-inline text-danger small"><?= $nama_peserta; ?></span>
                ...
                <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                    ...
                    <a class="dropdown-item" href="<?= site_url('c_home/logout'); ?>">
